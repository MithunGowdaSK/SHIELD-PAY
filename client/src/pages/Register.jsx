...
export default function Register() {
  ...
  const handlePhoneSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch("http://localhost:5000${import.meta.env.VITE_API_URL}/api/users/register", {
        method: "POST",
  ...
  const handleProfileSubmit = async () => {
    ...
    try {
      const res = await fetch(`http://localhost:5000${import.meta.env.VITE_API_URL}/api/users/${phone}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
